  ...
  methods: {
    ...
    async fetchKonten() {
      try {
        ...
        // DISABLED: Jangan ambil logo dari API karena file tidak persisten di Railway
        // Logo sudah di-hardcode dari assets
...
@media (max-width: 768px) {
  .hero {
    padding-top: 8rem !important; /* Force padding lebih besar untuk mobile/tablet */
  }
